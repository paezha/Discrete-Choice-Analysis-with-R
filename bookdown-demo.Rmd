...
<!--chapter:end:00-Installation.Rmd-->
...
<!--chapter:end:01-Data-and-Stuff.Rmd-->

---
title: "01b Exploratory data analysis"
output: html_notebook
---
...
<!--chapter:end:02-Exploratory-data-analysis.Rmd-->
...
<!--chapter:end:03-Fundamental-Concepts.Rmd-->
...
<!--chapter:end:05-Practical-Matters.Rmd-->
...
Direct-point elasticity is calculated at a point value of $x_ink$ (attribute $k$ of alternative $i$ of decision-maker $k$) with respect to the probability of selecting alternative $i$. This elasticity is useful when our question about behavior is as follows:
...
Next, we will estimate a second model that uses the regions variable to illustrate this (call this Model 2):
```{r}
...
The model can be reestimated using these constants. The option `reflevel` is used to select the alternative that will work as reference (call this Model 3; notice that the columns that vary needs to be updated to include the new alternative-related variable):
```{r}
mod3 <- mlogit(depvar ~ ic + oc, Heating, shape = "wide", choice = "depvar", reflevel = "ec", varying = c(3:12))
summary(mod3)
```

So, how can this model be used to understand consumer preferences? Recall that the question is at what rate are consumers willing to pay for installation relative to operation.
...
<!--chapter:end:06-Behavioral-Insights.Rmd-->
...
<!--chapter:end:07-Non-Proportional-Substitution-GEV.Rmd-->
...
<!--chapter:end:08-Non-Proportional-Substitution-Probit.Rmd-->
...
<!--chapter:end:09-Dealing-with-Heterogeneity-Latent-Class.Rmd-->
...
<!--chapter:end:10-Dealing-with-Heterogeneity-Mixed-Logit.Rmd-->
...
<!--chapter:end:11-Ordinal-Ranked.Rmd-->
