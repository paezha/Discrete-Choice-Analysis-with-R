...
5.  Download the code as a .zip file from this repository:
    ...
    on the "code" button on the top-right corner and select "Download ZIP". The
    repository contains a `renv.lock` file that specifies all the
    versions of the packages used in the [textbook](https://doi.org/10.1007/978-3-031-20719-8). 
    Unzip the file and store it in an appropriate directory. Use this folder to 
    work on the course.

6.  Open up the `.RProj` file called "Discrete-Choice-Analysis-with-R". This
